...
export const alt = "blaze-motion — Motion, tuned once. Subtle, RSC-safe motion primitives for Next.js + shadcn.";
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            ...
            <div style={{ display: "flex", fontSize: 30, fontWeight: 700, letterSpacing: -0.6, color: FOREGROUND }}>
              blaze-motion
            </div>
            <div
              style={{
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 48 }}>
            <div style={{ display: "flex", flexDirection: "column", maxWidth: 620 }}>
              <div style={{ display: "flex", fontSize: 92, fontWeight: 700, letterSpacing: -3, lineHeight: 1.02, color: FOREGROUND }}>
                Motion,
              </div>
              <div style={{ display: "flex", fontSize: 92, fontWeight: 700, letterSpacing: -3, lineHeight: 1.02, color: SIGNAL }}>
                tuned once.
              </div>
              <div style={{ display: "flex", marginTop: 30, fontSize: 27, lineHeight: 1.4, color: MUTED, maxWidth: 560 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div style={{ display: "flex", fontFamily: monoFamily, fontSize: 19, letterSpacing: 0.4, color: MUTED }}>
              motion.asmitsah.dev
            </div>
          </div>
        </div>
